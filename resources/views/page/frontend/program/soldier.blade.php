...
@section('title_page', 'Program / Dolphin Soldier')
...
@push('head')
    ...
    <style>
        #main {
            background-image: url("{{ asset(\crocodicstudio\crudbooster\helpers\CRUDBooster::getSetting('program_dolphin_background')) }}");
        }
        ...
        <div class="container-fluid position-relative">
            <nav aria-label="breadcrumb" data-aos="fade-down">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><b><i>DOLPHIN SOLDIER</i></b></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container-fluid detail-title-center">
            ...
            <div class="row">
                <div class="col-12 col-lg-12" data-aos="fade-down">
                    <p class="detail-title">DOLPHIN SOLDIER</p>
                </div>
                <div class="separator-right content-no-padding-left">
