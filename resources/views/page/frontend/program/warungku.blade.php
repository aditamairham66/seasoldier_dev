            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <ol data-aos="fade-down">
                        ...
                        <li><b><i>BERSIHKAN WARUNGKU</i></b></li>
                    </ol>
                </div>
            </div>
            <div class="row bg-pattern-left mt-5">
                <div class="col-lg-12 text-center">
                    <h4 class="title-program" data-aos="fade-down">BERSIHKAN WARUNGKU</h4>
                    <div class="caption-program" data-aos="fade-down">{!! nl2br($description) !!}</div>
