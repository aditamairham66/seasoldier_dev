...
@section('title_page', 'Program / Trees Conservation')
        ...
        <div class="container-fluid position-relative">
            <nav aria-label="breadcrumb" data-aos="fade-down">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><b><i>TREES CONSERVATION</i></b></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container-fluid detail-title-center">
            ...
            <div class="row">
                <div class="col-12 col-lg-12" data-aos="fade-down">
                    <p class="detail-title">TREES CONSERVATION</p>
                </div>
