                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        align="center">
                                                                        <a href="https://seasoldier.org/"
                                                                            target="_blank">
                                                                            <img align="center" border="0"
                                                                                src="https://seasoldier.org/img/logo/hitam.png"
                                                                                alt="" title=""
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">Hello
                                                                    dear,<br /><br /></p>
                                                                <p style="font-size: 14px; line-height: 140%;">Thank you
                                                                    for reaching out to us through
                                                                    the website. We just wanted to let you know we
                                                                    received your message and
                                                                    our<br />support team will be in touch with you very
                                                                    soon.</p>
                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;">Regards,
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    Seasoldier Team</p>
                                                                <p style="font-size: 14px; line-height: 140%;">&nbsp;
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p
                                                                    ...
                                                                    <span style="font-size: 10px; line-height: 14px;">Do
                                                                        not reply any email to this email
                                                                        address. This email sent automatically by our
                                                                        system.</span>
                                                                </p>
                                                            </div>
                                                        </td>
