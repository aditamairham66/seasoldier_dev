<?php namespace App\Http\Controllers;
	...
	class AdminProgramSoldierController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            $latest_sorting = DB::table('program_soldier')
                ->max('sort');
	    ...
	    */
        ...
        public function getMoveUp($id)
        {
            ...
            if ($find->sort == 1) {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-soldier'), 'Banner Home adalah program soldier dengan urutan teratas', 'danger');
            } elseif ($find->sort > 1) {
            ...
            return CRUDBooster::redirect(CRUDBooster::adminPath('program-soldier'), 'Berhasil merubah urutan program soldier', 'success');
        }
        ...
        public function getMoveDown($id)
        {
            ...
            $above = ProgramSoldier::findBy('sort', $find->sort + 1);
            if ($above->id == '') {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-soldier'), 'Banner Home adalah program soldier dengan urutan terbawah', 'danger');
            } elseif ($above->id != '') {
                $above->sort = $find->sort;
                $above->save();
