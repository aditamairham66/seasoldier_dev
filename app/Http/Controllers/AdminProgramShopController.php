<?php namespace App\Http\Controllers;
	...
	class AdminProgramShopController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
        ...
        public function getMoveUp($id)
        {
            ...
            if ($find->sort == 1) {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-shop'), 'Banner Home adalah program shop dengan urutan teratas', 'danger');
            } elseif ($find->sort > 1) {
            ...
            return CRUDBooster::redirect(CRUDBooster::adminPath('program-shop'), 'Berhasil merubah urutan program shop', 'success');
        }
        ...
        public function getMoveDown($id)
        {
            ...
            $above = ProgramShop::findBy('sort', $find->sort + 1);
            if ($above->id == '') {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-shop'), 'Banner Home adalah program shop dengan urutan terbawah', 'danger');
            } elseif ($above->id != '') {
                $above->sort = $find->sort;
                $above->save();
