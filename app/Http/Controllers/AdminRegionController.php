<?php namespace App\Http\Controllers;
	...
	class AdminRegionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:region','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:region","placeholder"=>"Please enter a valid email address"];
