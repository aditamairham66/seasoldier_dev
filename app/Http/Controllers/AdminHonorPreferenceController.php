...
class AdminHonorPreferenceController extends CBController
{
    var $list_image = ['Support Us Background', 'Fundraising Background', 'Our Partners Background', 'Merchandise Background'];
    ...
    public function hook_query_index(&$query)
    {
        $query->whereIn('name', [
            'support_background',
            'support_fundraising_background',
            'support_partners_background',
            'support_partners_description',
            'support_partners_join_link',
            'support_merchandise_background',
        ]);
    }
