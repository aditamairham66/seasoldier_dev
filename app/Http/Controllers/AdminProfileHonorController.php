<?php namespace App\Http\Controllers;
	...
	class AdminProfileHonorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            $latest_sorting = DB::table('profile_honor')
                ->max('sort');
	    ...
	    */
        ...
        public function getMoveUp($id)
        {
            ...
            if ($find->sort == 1) {
                return CRUDBooster::redirect(CRUDBooster::adminPath('profile-honor'), 'Profile Honor adalah profile honor dengan urutan teratas', 'danger');
            } elseif ($find->sort > 1) {
            ...
            return CRUDBooster::redirect(CRUDBooster::adminPath('profile-honor'), 'Berhasil merubah urutan profile honor', 'success');
        }
        ...
        public function getMoveDown($id)
        {
            ...
            $above = ProfileHonor::findBy('sort', $find->sort + 1);
            if ($above->id == '') {
                return CRUDBooster::redirect(CRUDBooster::adminPath('profile-honor'), 'Profile Honor adalah profile honor dengan urutan terbawah', 'danger');
            } elseif ($above->id != '') {
                $above->sort = $find->sort;
                $above->save();
