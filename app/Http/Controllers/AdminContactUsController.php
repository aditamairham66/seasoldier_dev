<?php namespace App\Http\Controllers;
	...
	class AdminContactUsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
//            $this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:contact_us','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:contact_us","placeholder"=>"Please enter a valid email address"];
