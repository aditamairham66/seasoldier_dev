<?php namespace App\Http\Controllers;
	...
	class AdminRegionRequestController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Date Request","name"=>"date_request"];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:region_request','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Date Request","name"=>"date_request","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"City","name"=>"city","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:region_request","placeholder"=>"Please enter a valid email address"];
