<?php namespace App\Http\Controllers;
	...
	class AdminGalleryController extends \crocodicstudio\crudbooster\controllers\CBController {
        ...
        public function cbInit() {
			...
			$this->col[] = ["label"=>"Instagram Image","name"=>"instagram_image","image"=>true];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ['label'=>'Instagram Url','name'=>'instagram_url','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','help'=>'example : https://www.instagram.com/p/CQTrAhXAncP'];
			//$this->form[] = ['label'=>'Instagram Name','name'=>'instagram_name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','help'=>'example : @mehdiii_trips'];
			# OLD END FORM
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            $reqInstagram = reqInstagram($postdata['instagram_url']);
            $postdata['instagram_image'] = $reqInstagram['thumbnail_url'];
            $postdata['instagram_content'] = $reqInstagram['title'];
