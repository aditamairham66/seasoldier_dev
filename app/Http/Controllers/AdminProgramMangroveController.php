<?php namespace App\Http\Controllers;
    ...
    use App\Repositories\ProgramMangrove;
    use Session;
	use Request;
	use DB;
	use CRUDBooster;

	class AdminProgramMangroveController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
            $query->orderby('program_mangrove.sort', 'asc');
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            $latest_sorting = DB::table('program_mangrove')
                ->max('sort');
	    ...
	    */
        ...
        {
            $find = ProgramMangrove::firstById($id);

            if ($find->sort == 1) {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-mangrove'), 'Banner Home adalah program mangrove dengan urutan teratas', 'danger');
            } elseif ($find->sort > 1) {
                $above = ProgramMangrove::findBy('sort', $find->sort - 1);
            ...
            return CRUDBooster::redirect(CRUDBooster::adminPath('program-mangrove'), 'Berhasil merubah urutan program mangrove', 'success');
        }
        ...
        public function getMoveDown($id)
        {
            ...
            $above = ProgramMangrove::findBy('sort', $find->sort + 1);
            if ($above->id == '') {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-mangrove'), 'Banner Home adalah program mangrove dengan urutan terbawah', 'danger');
            } elseif ($above->id != '') {
                $above->sort = $find->sort;
                $above->save();
