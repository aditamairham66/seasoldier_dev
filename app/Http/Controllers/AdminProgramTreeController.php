<?php namespace App\Http\Controllers;
	...
	class AdminProgramTreeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            $latest_sorting = DB::table('program_tree')
                ->max('sort');
	    ...
	    */
        ...
        public function getMoveUp($id)
        {
            ...
            if ($find->sort == 1) {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-tree'), 'Banner Home adalah program tree dengan urutan teratas', 'danger');
            } elseif ($find->sort > 1) {
            ...
            return CRUDBooster::redirect(CRUDBooster::adminPath('program-tree'), 'Berhasil merubah urutan program tree', 'success');
        }
        ...
        public function getMoveDown($id)
        {
            ...
            $above = ProgramTree::findBy('sort', $find->sort + 1);
            if ($above->id == '') {
                return CRUDBooster::redirect(CRUDBooster::adminPath('program-tree'), 'Banner Home adalah program tree dengan urutan terbawah', 'danger');
            } elseif ($above->id != '') {
                $above->sort = $find->sort;
                $above->save();
