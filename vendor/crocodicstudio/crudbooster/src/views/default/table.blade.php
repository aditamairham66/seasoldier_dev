                ...
                <div class="modal-content">
                    ...
                    <form method='get' action=''>
                        ...
                        <div class="modal-footer" align="right">
                            <button class="btn btn-sm btn-danger" type="button" data-dismiss="modal">{{cbLang("button_close")}}</button>
                            ...
                            <button class="btn btn-sm btn-primary btn-submit" type="submit">{{cbLang("button_submit")}}</button>
                        </div>
