...
@section("content")
    ...
    <ul class="nav nav-pills nav-secondary">
        ...
        <li class="nav-item" role="presentation"><a class="nav-link active" href="{{Route('ModulsControllerGetStep3')."/".$id}}"><i class='fa fa-plus-square-o'></i> Step 3 - Form Display</a></li>
        <li class="nav-item" role="presentation"><a class="nav-link" href="{{Route('ModulsControllerGetStep4')."/".$id}}"><i class='fa fa-wrench'></i> Step 4 - Configuration</a></li>
    </ul>
    @push('head')
        <style>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn-save-option btn btn-primary btn-sm">Save changes</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div class="card">
                ...
                <table class='table-form table table-striped'>
                    ...
                    @foreach($cb_form as $form)
                        <tr>
                            ...
                            <td>
                                <a class='btn btn-primary btn-options btn-sm' href='javascript:;'><i class='fa fa-cog'></i> Options</a>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="btn btn-xs btn-info btn-plus"><i class='fa fa-plus'></i></a>
                                <a href="javascript:void(0)" class="btn btn-xs btn-danger btn-delete"><i class='fa fa-trash'></i></a>
                                <a href="javascript:void(0)" class="btn btn-xs btn-success btn-up"><i class='fa fa-arrow-up'></i></a>
                                <a href="javascript:void(0)" class="btn btn-xs btn-success btn-down"><i class='fa fa-arrow-down'></i></a>
                            </td>
                        </tr>
                        <?php $index++;?>
                    @endforeach
                    ...
                    <tr id='tr-sample' style="display: none">
                        ...
                        <td>
                            <a class='btn btn-primary btn-options btn-sm' href='#'><i class='fa fa-cog'></i> Options</a>
                            <div class='option_area' style="display: none">
        ...
        <div class="box-footer">
            <div align="right" class="p-3">
                <button type="button" onclick="location.href='{{CRUDBooster::mainpath('step2').'/'.$id}}'" class="btn btn-sm btn-danger">&laquo; Back</button>
                <input type="submit" class="btn btn-sm btn-primary" value="Step 4 &raquo;">
            </div>
        </div>
        </form>
    </div>
