...
@section("content")
    ...
    <ul class="nav nav-pills nav-secondary">
        @if($id)
            <li class="nav-item" role="presentation"><a class="nav-link active" href="{{Route('ModulsControllerGetStep1')."/".$id}}"><i class='fa fa-info'></i> Step 1 - Module
                    Information</a></li>
        ...
        @else
            <li class="nav-item" role="presentation"><a class="nav-link active" href="#"><i class='fa fa-info'></i> Step 1 - Module Information</a></li>
            <li class="nav-item" role="presentation"><a class="nav-link" href="#"><i class='fa fa-table'></i> Step 2 - Table Display</a></li>
            <li class="nav-item" role="presentation"><a class="nav-link" href="#"><i class='fa fa-plus-square-o'></i> Step 3 - Form Display</a></li>
            <li class="nav-item" role="presentation"><a class="nav-link" href="#"><i class='fa fa-wrench'></i> Step 4 - Configuration</a></li>
        @endif
    </ul>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            ...
            <div class='pull-right p-3'>
                <a class='btn btn-sm btn-danger' href='{{Route("ModulsControllerGetIndex")}}'> {{cbLang('button_back')}}</a>
                <input type="submit" class="btn btn-sm btn-primary" value="Step 2 &raquo;">
            </div>
        </div>
        </form>
    </div>
