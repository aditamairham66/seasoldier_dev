...
@section("content")
    ...
    <ul class="nav nav-pills nav-secondary">
        ...
        <li class="nav-item" role="presentation"><a class="nav-link active" href="{{Route('ModulsControllerGetStep2')."/".$id}}"><i class='fa fa-table'></i> Step 2 - Table Display</a></li>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <div align="right" class="p-3">
                <button type="button" onclick="location.href='{{CRUDBooster::mainpath('step1').'/'.$id}}'" class="btn btn-sm btn-danger">&laquo; Back</button>
                <input type="submit" class="btn btn-sm btn-primary" value="Step 3 &raquo;">
            </div>
        </div>
        </form>
    </div>
