            ...
            <form action="{{ route('postForgot') }}" method="post">
                ...
                <div class="login-form">
                    ...
                    <div class="row form-sub m-0">
                        ...
                        <a href='{{route("getLogin")}}' class="link float-right">{{cbLang("click_here")}}</a>
                    </div>
                    <div class="form-action mb-3">
                        <button type="submit" class="btn btn-primary btn-rounded btn-login">{{cbLang("button_submit")}}</button>
                    </div>
                </div>
            </form>
		</div>
